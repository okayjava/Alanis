...
RESOURCES += src/qt/alanis.qrc src/qt/alanis_locale.qrc

TRANSLATIONS += src/qt/locale/alanis_bg.ts \
                src/qt/locale/alanis_de.ts \
                src/qt/locale/alanis_en.ts \
                src/qt/locale/alanis_es.ts \
                src/qt/locale/alanis_fi.ts \
                src/qt/locale/alanis_fr.ts \
                src/qt/locale/alanis_it.ts \
                src/qt/locale/alanis_ja.ts \
                src/qt/locale/alanis_pl.ts \
                src/qt/locale/alanis_pt.ts \
                src/qt/locale/alanis_ru.ts \
                src/qt/locale/alanis_sk.ts \
                src/qt/locale/alanis_sv.ts \
                src/qt/locale/alanis_vi.ts \
                src/qt/locale/alanis_zh_CN.ts \
                src/qt/locale/alanis_zh_TW.ts
