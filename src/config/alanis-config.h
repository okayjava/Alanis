/* src/config/alanis-config.h.  Generated from alanis-config.h.in by configure.  */
/* src/config/alanis-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://alanis.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Alanis Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Alanis Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "alanis"
