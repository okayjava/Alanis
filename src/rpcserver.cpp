...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ALS features */
        {"alanis", "masternode", &masternode, true, true, false},
        {"alanis", "masternodelist", &masternodelist, true, true, false},
        {"alanis", "mnbudget", &mnbudget, true, true, false},
        {"alanis", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"alanis", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"alanis", "mnsync", &mnsync, true, true, false},
        {"alanis", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"alanis", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use alanisd, or the -server option to alanis-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Alanis Alert\" admin@foo.com\n"),
...
{
    return "> alanis-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:25147/\n";
}
