...
#if defined(NDEBUG)
#error "Alanis cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Alanis Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 1) return 213000 * COIN;
		
	int64_t nSubsidy;
	
	if( nHeight > 1 && nHeight <= 3500 ) {
	        nSubsidy = 1 * COIN;
	} else if( nHeight > 3500 && nHeight <= 10000 ) {
	        nSubsidy = 60 * COIN;
	} else if( nHeight > 10000 && nHeight <= 18000 ) {
	        nSubsidy = 80 * COIN;
	} else if( nHeight > 18000 && nHeight <= 30000 ) {
	        nSubsidy = 100 * COIN;
