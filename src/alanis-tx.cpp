...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Alanis Core alanis-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  alanis-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded alanis transaction") + "\n" +
                               "  alanis-tx [options] -create [commands]   " + _("Create hex-encoded alanis transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded alanis transaction
